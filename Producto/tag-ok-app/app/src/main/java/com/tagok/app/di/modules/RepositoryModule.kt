...
import com.tagok.app.data.repository.NotificacionRepository
...
object RepositoryModule
{
    ...
    val notificacionRepository: INotificacionRepository by lazy {
        NotificacionRepository(ApiModule.notificacionApi)
    }
}