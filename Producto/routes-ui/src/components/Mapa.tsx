...
export function Mapa({ start, end }: { start: Coord; end: Coord }) {
    ...
    // 2. Calcular IDs de pórticos que ya están siendo usados en los cobros de la ruta
    const usedPorticoIds = useMemo(() => {
        ...
        cobros.forEach((cobro) => {
            if ("porticoId" in cobro) {
                ...
                // CobroTramo: agrega tanto entrada como salida
    ...
    // 3. Pórticos del mapa que NO aparecen en la ruta calculada
